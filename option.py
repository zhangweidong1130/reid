...
parser.add_argument('--use_fp16_and_distribute', type=bool, default=True)
parser.add_argument('--local_rank', type=int, default=0)


parser.add_argument("--resume", type=int, default=0, help='resume from specific checkpoint')
parser.add_argument("--feature_lenth", type=str, default='out', help='')
...
parser.add_argument("--trainer", type=str, default='trainer_dist_vit_kd', help='train py')


parser.add_argument('--use_centerloss', action='store_true')
parser.add_argument('--use_att', action='store_true')
parser.add_argument('--use_unlabel', action='store_true')
parser.add_argument('--use_hard_example', action='store_true')
parser.add_argument('--test_all', action='store_true')
parser.add_argument('--detect_flag', action='store_true')
parser.add_argument('--use_center_weight', action='store_true')
parser.add_argument('--savefeature', action='store_true')
